...
#SBATCH --output=out_-0375+0375_%a.out
#SBATCH --error=err_-0375+0375_%a.err
#SBATCH -A prk@v100
#SBATCH --array=0-99
...
args=(
    ...
    --output_dir ${WORK}/repos/Radio_WL_Generative_Forward_Model/outputs/paper/shear_response/g_-0375_+0375
)

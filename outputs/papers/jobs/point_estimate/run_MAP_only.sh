...
#SBATCH --job-name=point_estimate
#SBATCH --ntasks=1
...
args=(
    ...
    --lr_map 5e-2
    --n_steps_map 1500
    --lr_map_shear_factor 2.
    --sampler mclmc
    --n_warmup 5000
    --num_chains 4
    --num 5
    --num_steps 500
    --id map_run_${SLURM_ARRAY_TASK_ID}
    --save_samples
    --save_plots
    --save_data
    --output_dir /lustre/fswork/projects/rech/prk/uds36vp/repos/Radio_WL_Generative_Forward_Model/outputs/paper/point_estimate_noisy
)

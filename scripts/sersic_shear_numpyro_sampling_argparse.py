...
def main():
    ...
    parser.add_argument('--hlr_prior_scale', type=float, default=1/1.4, help='Half-light radius prior scale')
    ...
    parser.add_argument('--flux_prior_scale', type=float, default=1/15., help='Flux prior scale')

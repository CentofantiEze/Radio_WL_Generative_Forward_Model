...
#SBATCH --job-name=run_-25_25    # nom du job
...
#SBATCH --output=out_run_-25_25_%a.out   # nom du fichier de sortie
#SBATCH --error=err_run_-25_25_%a.err    # nom du fichier d'erreur (ici commun avec la sortie)
...
args=(
    ...
    --num 20 
    --num_steps 5000 
    --id run_-25_25_id_${SLURM_ARRAY_TASK_ID} 
    # --save_samples false
    --plot_chains scaled
    --output_dir /lustre/fswork/projects/rech/prk/uds36vp/repos/Radio_WL_Generative_Forward_Model/outputs/shear_response/run_-25_25
)

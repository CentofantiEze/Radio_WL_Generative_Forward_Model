...
#SBATCH --job-name=run_25_25    # nom du job
...
#SBATCH --output=out_run_25_25_%a.out   # nom du fichier de sortie
#SBATCH --error=err_run_25_25_%a.err    # nom du fichier d'erreur (ici commun avec la sortie)
...
args=(
    ...
    --num 20 
    --num_steps 5000 
    --id run_25_25_id_${SLURM_ARRAY_TASK_ID} 
    # --save_samples false
    --plot_chains scaled
    --output_dir /lustre/fswork/projects/rech/prk/uds36vp/repos/Radio_WL_Generative_Forward_Model/outputs/shear_response/run_25_25
)
